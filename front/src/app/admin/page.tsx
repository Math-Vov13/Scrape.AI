        ...
        <aside className="w-64 border-r border-border bg-card p-4">
          <nav className="space-y-2">
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
                activeTab === 'files' ? 'bg-primary text-primary-foreground' : 'hover:bg-secondary'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
                activeTab === 'conversations' ? 'bg-primary text-primary-foreground' : 'hover:bg-secondary'
              }`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
                activeTab === 'stats' ? 'bg-primary text-primary-foreground' : 'hover:bg-secondary'
              }`}
            >
